...
parser = argparse.ArgumentParser(description='This script will generate a filelist file which will be used by paq8px_v177.exe for compressing. It is also used for testing if you use the -t argument')
optional = parser._action_groups.pop()
required = parser.add_argument_group('required arguments')
required.add_argument('-i', '--input', help="Input file or folder to compress. REQUIRED", required=True)
optional.add_argument('-v', '--version', help='Version of PAQ8PX to use. Example: 177. Default is 177', required=False, default='177')
